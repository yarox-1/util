...
void GeoTest::testCRS() {
  {
    ...
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84> "
                              "MULTIPOINT(0 0, 1 1)", 0),
        ==, WKTType::MULTIPOINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84>M"
                              "ULTIPOINT(0 0, 1 1)", 0),
        ==, WKTType::MULTIPOINT);
    TEST(util::geo::getWKTType(" <http://www.opengis.net/def/crs/OGC/1.3/CRS84>"
                              " MULTIPOINT(0 0, 1 1)", 0),
    ...
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84> "
        ...
        ==, WKTType::MULTIPOINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84> "
                              " MMULTIPOINT Z(0 0, 1 1)", 0),
        ==, WKTType::MULTIPOINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84> "
                              " MULTIPOINT Z(0 0, 1 1)", 0),
        ==, WKTType::MULTIPOINT);

    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> POINT(1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> POIN (1 1)", 0),
        ==, WKTType::NONE);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> POINT (1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> Point (1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> POINT Z(1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326>   POINT Z (1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> POINT ZM(1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> Point MZ (1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> mPoint MZ (1 1)", 0),
        ==, WKTType::POINT);
    TEST(util::geo::getWKTType("<http://www.opengis.net/def/crs/EPSG/0/4326> oint MZ (1 1)", 0),
        ==, WKTType::NONE);
  ...
  {
    // Test CRS Type
    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84> "
                              "MULTIPOINT(0 0, 1 1)", 0),
        ==, CRSType::CRS84);
    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/OGC/1.3/CRS84>M"
                              "ULTIPOINT(0 0, 1 1)", 0),
        ==, CRSType::CRS84);

    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/EPSG/0/4326> POINT(1 1)", 0),
        ==, CRSType::WGS84);
    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/EPSG/0/4326> POINT (1 1)", 0),
        ==, CRSType::WGS84);

    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/EPSG/0/3857>LINESTRING(0 0, 1 1)", 0),
        ==, CRSType::WEB_MERCATOR);
    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/EPSG/0/3857>MLINESTRING(0 0, 1 1)", 0),
        ==, CRSType::WEB_MERCATOR);

    TEST(util::geo::getCRSType("MULTIPOINT(0 0, 1 1)", 0),
        ==, CRSType::CRS84);
    TEST(util::geo::getCRSType("MMULTIPOINT(0 0, 1 1)", 0),
        ==, CRSType::CRS84);

    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/EPSG/0/28992> LINESTRING(0 0, 1 1)", 0),
        ==, CRSType::UNSUPPORTED);
    TEST(util::geo::getCRSType("<http://www.opengis.net/def/crs/EPSG/0/28992> MLINESTRING(0 0, 1 1)", 0),
        ==, CRSType::UNSUPPORTED);
  ...
  }
  {
    ...
    // TO CRS84
    auto projCRS84 = util::geo::pointFromWKTProj<double>(
    ...
    auto projWGS84 = util::geo::pointFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> POINT(3 2)",
        util::geo::projectToCRS84<double>);
    TEST(projWGS84.getX(), ==, 2.0);
    TEST(projWGS84.getY(), ==, 3.0);

    auto projWebMerc = util::geo::pointFromWKTProj<double>(
    ...
    // to WGS84
    auto projCRS842 = util::geo::pointFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> POINT(2 3)",
        util::geo::projectToWGS84<double>);
    TEST(projCRS842.getX(), ==, 3.0);
    TEST(projCRS842.getY(), ==, 2.0);

    auto projWGS842 = util::geo::pointFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> POINT(3 2)",
        util::geo::projectToWGS84<double>);
    TEST(projWGS842.getX(), ==, 3.0);
    TEST(projWGS842.getY(), ==, 2.0);

    auto projWebMerc2 = util::geo::pointFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> POINT(222638.98158654 334111.17140195)",
        util::geo::projectToWGS84<double>);
    ...
    auto projCRS844 = util::geo::pointFromWKT<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> POINT(2 3)");
    TEST(projCRS844.getX(), ==, 2.0);
    TEST(projCRS844.getY(), ==, 3.0);

    auto projWGS844 = util::geo::pointFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> POINT(3 2)");
    TEST(projWGS844.getX(), ==, 2.0);
    TEST(projWGS844.getY(), ==, 3.0);

    auto projWebMerc4 = util::geo::pointFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> POINT(222638.98158654 334111.17140195)");
  ...
  }
  {
    ...
    // TO CRS84
    auto projCRS84 = util::geo::lineFromWKTProj<double>(
    ...
    auto projWGS84 = util::geo::lineFromWKTProj<double>(
    ...
    auto projWebMerc = util::geo::lineFromWKTProj<double>(
    ...
    // to WGS84
    auto projCRS842 = util::geo::lineFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> LINESTRING(7 47, 7 48)",
        util::geo::projectToWGS84<double>);
    ...
    auto projWGS842 = util::geo::lineFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> LINESTRING(47 7, 48 7)",
        util::geo::projectToWGS84<double>);
    ...
    auto projWebMerc2 = util::geo::lineFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> LINESTRING(779236.435552915 "
        "5942074.072431109, 779236.435552915 6106854.834885074)",
        util::geo::projectToWGS84<double>);
    ...
    // to WebMerc
    auto projCRS843 = util::geo::lineFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> LINESTRING(7 47, 7 48)",
        util::geo::projectToWebMerc<double>);
    ...
    auto projWGS843 = util::geo::lineFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> LINESTRING(47 7, 48 7)",
        util::geo::projectToWebMerc<double>);
    ...
    auto projWebMerc3 = util::geo::lineFromWKTProj<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> LINESTRING(779236.435552915 "
        "5942074.072431109, 779236.435552915 6106854.834885074)",
        util::geo::projectToWebMerc<double>);
    ...
    // Without projection function.
    auto projCRS844 = util::geo::lineFromWKT<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> LINESTRING(7 47, 7 48)");
    ...
    auto projWGS844 = util::geo::lineFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> LINESTRING(47 7, 48 7)");
    ...
    auto projWebMerc4 = util::geo::lineFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> LINESTRING(779236.435552915 "
        "5942074.072431109, 779236.435552915 6106854.834885074)");
  ...
  }
  {
    ...
    // Without projection function.
    auto projCRS84 = util::geo::polygonFromWKT<double>(
    ...
    auto projWGS84 = util::geo::polygonFromWKT<double>(
    ...
    auto projWebMerc = util::geo::polygonFromWKT<double>(
  ...
  }
  {
    ...
    // Without projection function.
    auto projCRS84 = util::geo::multiLineFromWKT<double>(
    ...
    auto projWGS84 = util::geo::multiLineFromWKT<double>(
    ...
    auto projWebMerc = util::geo::multiLineFromWKT<double>(
  ...
  }
  {
    ...
    auto projCRS842 = util::geo::multiPointFromWKT<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> MULTIPOINT(7 47, 8 48)");
    TEST(getWKT(projCRS842), ==, "MULTIPOINT(7 47,8 48)");

    auto projWGS842 = util::geo::multiPointFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> MULTIPOINT(47 7, 48 8)");
    TEST(getWKT(projWGS842), ==, "MULTIPOINT(7 47,8 48)");

    auto projWebMerc2 = util::geo::multiPointFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> MULTIPOINT(779236.435552915 5942074.072431109,"
        " 890555.9263461885 6106854.834885074)");
  ...
  }
  {
    ...
    // Without projection function.
    auto projCRS84 = util::geo::multiPolygonFromWKT<double>(
    ...
    auto projWGS84 = util::geo::multiPolygonFromWKT<double>(
    ...
    auto projWebMerc = util::geo::multiPolygonFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> MULTIPOLYGON(((779236.435552915 5942074.072431109,"
        " 890555.9263461885 5942074.072431109, 890555.9263461885 6106854.834885074, 779236.435552915 6106854.834885074,"
  ...
  }
  {
    ...
    // Without projection function.
    auto projCRS84 = util::geo::collectionFromWKT<double>(
    ...
    TEST(getWKT(projWGS84), ==,
        "GEOMETRYCOLLECTION(POINT(7 47),LINESTRING(7 47,8 48),POLYGON((7 47,8 47,8 48,7 48,7 47)))");

    auto projWebMerc = util::geo::collectionFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> GEOMETRYCOLLECTION(POINT(779236.435552915 5942074.072431109),"
        ...
        "6106854.834885074, 779236.435552915 5942074.072431109)))");
    TEST(getWKT(projWebMerc), ==,
        "GEOMETRYCOLLECTION(POINT(7 47),LINESTRING(7 47,8 48),POLYGON((7 47,8 47,8 48,7 48,7 47)))");

    // Test collection of other geometries.
    auto projCRS842 = util::geo::collectionFromWKT<double>(
        "<http://www.opengis.net/def/crs/OGC/1.3/CRS84> GEOMETRYCOLLECTION(MULTIPOINT(7 47, 8 48), "
        "MULTIPOLYGON(((7 47, 8 47, 8 48, 7 48, 7 47)), ((8 48, 9 48, 9 49, 8 49, 8 48))), "
        "MULTILINESTRING((7 47, 8 47), (8 48, 7 48)))");
    TEST(getWKT(projCRS842), ==,
    ...
    auto projWGS842 = util::geo::collectionFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/4326> GEOMETRYCOLLECTION(MULTIPOINT(47 7, 48 8), "
        "MULTIPOLYGON(((47 7, 47 8, 48 8, 48 7, 47 7)), ((48 8, 48 9, 49 9, 49 8, 48 8))), "
        "MULTILINESTRING((47 7, 47 8), (48 8, 48 7)))");
    TEST(getWKT(projWGS842), ==,
        "GEOMETRYCOLLECTION(MULTIPOINT(7 47,8 48),MULTIPOLYGON(((7 47,8 47,8 48,7 48,7 47)),"
        "((8 48,9 48,9 49,8 49,8 48))),MULTILINESTRING((7 47,8 47),(8 48,7 48)))");

    auto projWebMerc2 = util::geo::collectionFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> GEOMETRYCOLLECTION(MULTIPOINT(779236.435552915"
        " 5942074.072431109, 890555.9263461885 6106854.834885074), MULTIPOLYGON(((779236.435552915 "
        "5942074.072431109, 890555.9263461885 5942074.072431109, 890555.9263461885 6106854.834885074,"
        " 779236.435552915 6106854.834885074, 779236.435552915 5942074.072431109)), ((890555.9263461885"
        " 6106854.834885074, 1001875.4171394621 6106854.834885074, 1001875.4171394621 6274861.394006576,"
        " 890555.9263461885 6274861.394006576, 890555.9263461885 6106854.834885074))), "
        "MULTILINESTRING((779236.435552915 5942074.072431109, 890555.9263461885 5942074.072431109),"
        " (890555.9263461885 6106854.834885074, 779236.435552915 6106854.834885074)))");
    TEST(getWKT(projWebMerc2), ==,
        "GEOMETRYCOLLECTION(MULTIPOINT(7 47,8 48),MULTIPOLYGON(((7 47,8 47,8 48,7 48,7 47)),"
        "((8 48,9 48,9 49,8 49,8 48))),MULTILINESTRING((7 47,8 47),(8 48,7 48)))");
  }

  {
    ...
    auto projWebMerc_6 = util::geo::multiPolygonFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> MULTIPOLYGON(((779236.435552915 5942074.072431109,"
        " 890555.9263461885 5942074.072431109, 890555.9263461885 6106854.834885074, 779236.435552915 6106854.834885074,"
        " 779236.435552915 5942074.072431109)), ((890555.9263461885 6106854.834885074, 1001875.4171394621 6106854.834885074,"
        " 1001875.4171394621 6274861.394006576, 890555.9263461885 6274861.394006576, 890555.9263461885 6106854.834885074)))");
    ...
    auto projWebMerc_7 = util::geo::collectionFromWKT<double>(
        "<http://www.opengis.net/def/crs/EPSG/0/3857> GEOMETRYCOLLECTION(POINT(779236.435552915 5942074.072431109),"
        " LINESTRING(779236.435552915 5942074.072431109, 890555.9263461885 6106854.834885074), POLYGON((779236.435552915"
        " 5942074.072431109, 890555.9263461885 5942074.072431109, 890555.9263461885 6106854.834885074, 779236.435552915 "
        "6106854.834885074, 779236.435552915 5942074.072431109)))");
